...
function App() {
  ...
  const agregarColaborador = (nuevoColaborador) => {
    if (
      ...
      setAppAlertMessage("Faltan campos por completar");
      ...
      setAppAlertMessage("Colaborador agregado exitosamente");
  ...
  // Filtrar colaboradores en base al término de búsqueda
